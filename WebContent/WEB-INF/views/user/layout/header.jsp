...
<div id="header-topbar-option" class="page-header-topbar">
	<nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3" 
		...
		<div class="navbar-header">
			...
			<a id="logo" href="${pageContext.request.contextPath }/admin/loginForm.do" class="navbar-brand">
				<span class="logo-text text-yellow" style="font-size: 16px;"><b>당근나라</b></span>
			</a>
		</div>
