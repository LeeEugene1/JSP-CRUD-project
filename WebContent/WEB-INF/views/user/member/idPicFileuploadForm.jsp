...
<script type="text/javascript">
	...
	function idFileUpload(fileName) {
		...
		fileName = fileNameArray[fileNameArray.length-1];	// 배열 마지막 인덱스 접근
				...
				<table width="300" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td height="38" background="${pageContext.request.contextPath }/image/open_tt.gif" align="center">
							<form id="idPicForm" action="${pageContext.request.contextPath}/user/member/idPicFileupload.do" 
								method="post" enctype="multipart/form-data">
								<input type="text" id="fileName" name="fileName"/>
								<span id="hiddenFileInput">
	    							<input type="file" id="idPic" name="idPic" onchange="idFileUpload(this.value);"/>
								</span>
							</form>
						</td>
					</tr>
