...
// 페이지네이션 UI 작성
public class RolePagingUtileMember {
	private int currentPage;		// 현재 페이지 번호
	private int totalCount;  		// 전체 게시글 수
	private int blockCount;    // 페이지별 출력 게시글 수
	...
	public RolePagingUtileMember(HttpServletRequest request, int totalCount, int currentPage, int blockCount) {
